...
/**
 * function to do the authorization
 * @param {*} req 
 * @param {*} res 
 * @param {*} next 
 */
...
/**
 * function that take a code parameter to do the exchange code for token 
 * @param {*} code 
 */
...
/**
 * function that take a token  parameter to do  , get the user info 
 * @param {*} token 
 */
